...
namespace TSystems.RELOAD.Transport
{
    ...
    public class Destination
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            Destination d = obj as Destination;
            ...
            // compare fields
            return (this.type == d.type && this.destination_data.node_id == d.destination_data.node_id && this.destination_data.ressource_id == d.destination_data.ressource_id);
        }
        ...
        public override int GetHashCode()
        {
            ...
            hash = hash * 23 + destination_data.node_id.GetHashCode();
            hash = hash * 23 + destination_data.ressource_id.GetHashCode();
            return hash;
        }
    ...
    public class SecurityBlock
    {
        ...
        public NodeId OriginatorNodeID
        {
            get
            {
                ...
                var signerCert = new X509Certificate2();
                ...
                foreach (GenericCertificate cert in certificates)
                {
                    ...
                    {
                        signerCert = new X509Certificate2(cert.Certificate);
                        break;
                    }
                }
    ...
    public class PingReqAns : RELOAD_MessageBody
    {
        ...
        public PingReqAns(UInt64 response_id, bool req)
        {
            if (!req)
            {
                ...
                received_ping = true; //for signature verification
            }
    ...
    public class StoreReq : RELOAD_MessageBody
    {
        ...
        public byte setReplicaNumber()
        {
            this.replica_number = 1;
    ...
    public class AttachReqAns : RELOAD_MessageBody
    {
        ...
        public List<IceCandidate> IPAddressToIceCandidate(IPAddress ip, int portNum)
        {
            ...
            ///* same on UDP with same port number                markus: for now we only use TCP            */
